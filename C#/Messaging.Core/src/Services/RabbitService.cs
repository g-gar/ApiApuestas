...
{
	public class RabbitService<TPublisher, TConsumer> : IRabbitService where TPublisher : class, IRabbitPublisherSetup, new() where TConsumer : class, IRabbitConsumerSetup, new()
	{
